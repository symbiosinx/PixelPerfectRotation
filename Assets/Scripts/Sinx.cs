...
public struct Sinx {
    ...
    #region Vector2 Functions
        public static Vector2 Cis(float angle, bool radians=true) {
...
public static class Extensions {
    ...
    public static Vector2 ToCartesian(this Vector2 pol) {
        return Sinx.Cis(pol.x) * pol.y;
    }
    ...
    public static Vector2 SnapToPixel(this Vector2 v, int pixelsPerUnit=16) {
        return new Vector2(v.x.SnapToPixel(pixelsPerUnit), v.y.SnapToPixel(pixelsPerUnit));
    }

    public static Vector3 SnapToPixel(this Vector3 v, int pixelsPerUnit=16) {
        return new Vector3(v.x.SnapToPixel(pixelsPerUnit), v.y.SnapToPixel(pixelsPerUnit), v.z.SnapToPixel(pixelsPerUnit));
    }
